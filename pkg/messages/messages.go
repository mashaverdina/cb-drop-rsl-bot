...
// clans menu
const (
	ClansEnter = "🙂->🏡 Вступить в клан"
	ClansExit  = "🏡->🙂 Выйти из клана"
)
...
// clans menu msgs
const (
	ClansEnterMsg = "Чтобы вступить в клан, отправь мне сообщение \"/joinclan \\[имя клана\\]\"\n" +
		"Имя клана должно быть строкой длины не более 64 символов без пробелов. Лучше использовать очень сложное имя клана, чтобы люди не попадали в клан случайно.\n" +
		"Обрати внимание, что здесь нет КЛ-ов. Никто не сможет удалять людей из клана. Пользователь может только сам выйти из клана. Ты вступаешь в клан на свой страх и риск."
)
